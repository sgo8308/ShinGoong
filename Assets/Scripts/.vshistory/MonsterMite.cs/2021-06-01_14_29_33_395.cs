    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            if (nextMove == 1)
            {
                ...
                radarRectTranform.rotation = Quaternion.Euler(radarRectTranform.rotation.x, 0, radarRectTranform.rotation.z);
            }
            else
            {
                _spriteRenderer.flipX = false;
                radarRectTranform.rotation = Quaternion.Euler(radarRectTranform.rotation.x, 180, radarRectTranform.rotation.z);
            }
        }  
    }
