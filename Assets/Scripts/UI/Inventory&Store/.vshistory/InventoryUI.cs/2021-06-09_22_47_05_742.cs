...
public class InventoryUI : MonoBehaviour
{
    ...
    public void SetToolTipInfo(Item item, bool isInStore, bool isWithStore, bool isInEquippedSlot)
    {
        ...
        if (isInStore)
        {
            itemToolTip.transform.Find("Price")
                             ...
                             .text = item.priceInStore.ToString();
        ...
        if (isWithStore)
        {
            itemToolTip.transform.Find("Price")
                             .Find("CoinCount")
                             .GetComponent<TextMeshProUGUI>()
                             .text = item.priceInInventory.ToString();
